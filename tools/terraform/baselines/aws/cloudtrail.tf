# cloudtrail.tf
# Control Coverage: AU-2 (audit events), AU-12 (audit generation), AU-10 (non-repudiation via log-file validation)
...
# AU-10: enable_log_file_validation makes CloudTrail emit an hourly digest file
# signed by an AWS-managed key, giving tamper detection on the audit trail itself.
